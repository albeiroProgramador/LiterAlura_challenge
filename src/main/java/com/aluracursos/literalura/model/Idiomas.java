...
public enum Idiomas {
    ...
    public static Idiomas fromString(String codigo) {
        ...
        throw new IllegalArgumentException("El código no existe o mal escrito: " + codigo);
    }
    ...
    public static String obtenerCodigoPorNombre(String nombreIdioma) {
        ...
        throw new IllegalArgumentException("El idioma no existe, intenta con otro: " + nombreIdioma);
    }
}
